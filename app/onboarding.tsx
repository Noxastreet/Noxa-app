...
import {
  IntroCardDeck,
  type IntroCardDeckHandle,
  type IntroCardPage,
} from '@/src/features/onboarding/IntroCardDeck';
...
export default function OnboardingScreen() {
  ...
  const goToPreviousPage = useCallback((index: number) => {
  ...
  const handleBack = useCallback(() => {
    ...
    if (pageIndex > 0) {
      goToPreviousPage(pageIndex - 1);
      return true;
    }

    if (isReplay) router.back();
    return true;
  }, [backToIntro, goToPreviousPage, isReplay, pageIndex, stage, vehicleSelection]);
      ...
      <View style={styles.screen}>
        ...
        <View style={styles.footer}>
          ...
          <NoxaButton
            ...
            fullWidth
            onPress={pageIndex === pages.length - 1 ? continueFromIntro : advancePage}
